# Form implementation generated from reading ui file 'c:\Users\user\Desktop\wtf2.0\desiner\add_subject_form.ui'
#
...
class Ui_AddSubjectForm(object):
    def setupUi(self, AddSubjectForm):
        ...
        AddSubjectForm.setStyleSheet("background-color: dodger")
        self.horizontalLayout = QtWidgets.QHBoxLayout(AddSubjectForm)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.widget = QtWidgets.QWidget(parent=AddSubjectForm)
        ...
        self.class_line = QtWidgets.QLineEdit(parent=self.widget)
...
"color: black;")
        ...
        self.error_lab1 = QtWidgets.QLabel(parent=self.widget)
        font = QtGui.QFont()
        font.setPointSize(11)
...
"color: black;")
        ...
        self.error_lab2 = QtWidgets.QLabel(parent=self.widget)
        font = QtGui.QFont()
        font.setPointSize(11)
